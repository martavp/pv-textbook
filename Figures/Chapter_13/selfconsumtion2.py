...
plt.fill_between(x,data.load,edgecolor='k',linewidth=1,label='Imported from the grid')
plt.fill_between(x,data.PV,0,edgecolor='k',linewidth=1,label='PV generation')
plt.fill_between(x,data.exported,edgecolor='k',linewidth=1,label='Exported to the grid')
plt.fill_between(x,data.bat_in,edgecolor='k',linewidth=1,label='Battery charge')
plt.fill_between(x,data.bat_out,data.load,edgecolor='k',linewidth=1,label='Battery discharge')
